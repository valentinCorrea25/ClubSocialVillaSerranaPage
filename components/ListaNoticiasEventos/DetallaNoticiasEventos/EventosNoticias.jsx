...
import { EnvironmentOutlined, FileTextOutlined, CalendarOutlined, TagOutlined} from '@ant-design/icons';
    ...
    return (
        ...
        title={
          <div style={{ backgroundColor: 'var(--verde-oscuro)', color: 'var(--blanco)', padding: '16px', borderRadius: '4px', width: '100%' }}>
            <div className="text-2xl font-bold text-center">{eventosnoticias?.titulo || 'Título no disponible'}</div>
          </div>
        }
    ...
    return (
      ...
      >
        <p className="text-gray-800 mb-2">
          <FileTextOutlined style={{ marginRight: 8,  fontSize:25, textAlign:'justify'}} />
          {eventosnoticias?.contenido || 'informacion no disponible'}
        </p>
      </Card>    
    );
  }
