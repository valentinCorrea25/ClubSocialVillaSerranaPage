...
export default function EditRestaurantes({
  restaurante,
  urlGoogle,
  setUrlGoogle,
  diasSemana,
  ...
  return (
    <>
      ...
      <div className="mt-6 space-y-6">
        {/* Sección de Horarios */}
        <div className="bg-white p-1 md:p-6">
          <h2 className="text-2xl font-semibold text-center mb-6">Horarios</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Form.Item
              label="Horarios Semanal"
              name="horario_semanal"
              initialValue={restaurante.horario_semanal}
            >
              <Input />
            </Form.Item>
            ...
            <Form.Item
              ...
              name="horario_finde"
              initialValue={restaurante.horario_finde}
            >
              <Input />
            </Form.Item>
          </div>
        ...
        <div className="bg-white p-1 md:p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Form.Item
              label="Facebook"
              name="facebook"
              initialValue={restaurante.facebook}
            >
              <Input />
            </Form.Item>
            ...
            <Form.Item
              label="Instagram"
              name="instagram"
              initialValue={restaurante.instagram}
            >
              <Input />
            </Form.Item>
        ...
        <div className="bg-white p-1 md:p-6">
          ...
          <Form.Item
            label="Tipos de pago"
            name="tipo_pago"
            initialValue={restaurante.tipo_pago}
          >
            <Select
              mode="multiple"
