...
export default function Alquileres() {
  ...
  return (
      <Form
        ...
        className=""
      >
        <div className="w-full flex flex-col md:flex-row gap-10 justify-center p-1">
          <div className="w-full md:w-1/2 flex flex-col py-4 px5">
          ...
          <div className="w-full md:w-1/2 flex flex-col gap-4">
            <div className="flex h-full flex-col py-4 md:p-5">
              <h1 className="text-center text-xl md:text-2xl mb-6">
        ...
        <div className="w-full md:w-1/2 flex flex-col gap-4 mx-auto">
            <div className="flex h-full flex-col py-4 md:p-5">
              <h1 className="text-center text-xl md:text-2xl mb-6">Ubicación</h1>
              <Form.Item
        ...
        <div className="w-full py-4 md:px-[5%] md:py-[5%] my-4">
          <h1 className="text-center text-xl md:text-2xl mb-6">
          ...
          <Form.Item name="caracteristicas">
            <Checkbox.Group
              ...
              className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 p-4 max-w-3xl items-center m-auto"
            />
          </Form.Item>
