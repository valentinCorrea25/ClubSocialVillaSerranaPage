...
const GoogleMap = () => {
  return (
    <div className="flex flex-col items-center lg:p-8">
      <h1 className="text-center text-4xl font-semibold mb-4">DESCUBRE VILLA SERRANA</h1>
      <div className="bg-[--blanco] p-6 rounded-xl shadow-lg mx-auto" style={{ width: '90%', maxWidth: '1300px' }}>
