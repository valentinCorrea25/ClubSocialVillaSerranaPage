        ...
        {type == 1 ? (
          <>
            <div className='p-2 shadow-md border w-full'>
              ...
              <h3 className='font-normal flex items-center gap-0.5'><FaHouse size={10}/> Hasta <span className='font-extrabold'> {Math.floor(Math.random() * 10)}</span> personas</h3>          
            </div>
          </>) : 
          ...
          type == 2 ? (
            <>
             <div className='p-2 shadow-md border w-full'>
                ...
                <h2 className='font-normal flex items-center gap-0.5'><FaMapMarkerAlt size={10}/>Ubicacion: {informacion.ubicacion}</h2>
                <h2 className='font-normal flex items-center gap-0.5'><FaClock size={10}/>Lunes a Viernes: {informacion.horario_semanal}</h2>
          ...
          type == 4 ? (
            <>
              <div className='p-2 shadow-md border w-full'>
                ...
                <h1 className='font-extrabold text-lg cursor-pointer'> {informacion.titulo.length > 24 ? informacion.titulo.substring(0,24)+"..." : informacion.titulo}</h1>
                <h2 className='font-normal flex items-center gap-0.5'><FaClock size={10}/>Horario {informacion.horario}</h2>
          ...
          type == 5 ? (
            ...
            <div className='w-full text-center max-w-56'>
              ...
              <h2 className='font-normal justify-center flex items-center gap-0.5'><FaWhatsapp/> Contacto: {informacion.celular.substring(0, 12)}</h2>
