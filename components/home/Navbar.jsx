  ...
  const items = [
    {
      label: (
        <a 
          className="relative block w-full min-w-full py-2 px-4 hover:text-gray-900 hover:bg-green-300 hover:rounded-md hover:border-r-4 hover:border-[--verde] transition-all m-0"
          onClick={() => router.push('/ListaRestaurantes')} 
          target="_blank" 
        >
          Restaurantes
        </a>
    ...
    },
    {
      label: (
        <a 
          className="relative block w-full min-w-full py-2 px-4 hover:text-gray-900 hover:bg-green-300 hover:rounded-md hover:border-r-4 hover:border-[--verde] transition-all m-0"
          onClick={() => router.push('/ListaAlojamiento')} 
          target="_blank"
        >
          Alojamientos
        </a>
    ...
    { 
      label: (
        <a 
          className="relative block w-full min-w-full py-2 px-4 hover:text-gray-900 hover:bg-green-300 hover:rounded-md hover:border-r-4 hover:border-[--verde] transition-all m-0"
          onClick={() => router.push('/ListaActividades')} 
          target="_blank" 
        >
          Actividades
        </a>
      ...
      label: (
        <a 
          className="relative block w-full min-w-full py-2 px-4 hover:text-gray-900 hover:bg-green-300 hover:rounded-md hover:border-r-4 hover:border-[--verde] transition-all m-0"
          onClick={() => router.push('/ListaEventosNoticias')} 
          target="_blank"
        >
          Eventos e Noticias
        </a>
  ...
  return (
    <nav className="bg-[--blanco] border-b-4 border-[--verder-super-oscuro] montserrat z-[5000]">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-3">
        <a href="/">
          <Image src={logo} width={0} height={0} className="w-20 md:w-32" alt="Logo Villa Serrana Club Social y Deportivo" />
        </a>
        <button 
          onClick={toggleMenu} 
          type="button" 
