...
=======
      ...
      <Image src={logo} width={0} height={0} className="w-[12%] absolute top-3 left-10 z-50" alt="Logo Villa Serrana Club Social y Deportivo" />
>>>>>>> ef49394770fb8a6ffaf8fb856b4075878367d7d1
        </a>
        <div className='h-8'/>
